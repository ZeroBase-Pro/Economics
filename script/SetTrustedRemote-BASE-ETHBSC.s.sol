...
contract SetTrustedRemoteScript is Script {
    ...
    function run() public {
        ...
        // ========== BSC Testnet ==========
        ZEROBASE baseContract = ZEROBASE(BASE_CONTRACT);
        baseContract.setPeer(ETH_CHAIN_ID, bytes32(uint256(uint160(ETH_CONTRACT))));
        baseContract.setPeer(BSC_CHAIN_ID, bytes32(uint256(uint160(BSC_CONTRACT))));
        console2.log("Set ETH and BSC as peer on BASE");
