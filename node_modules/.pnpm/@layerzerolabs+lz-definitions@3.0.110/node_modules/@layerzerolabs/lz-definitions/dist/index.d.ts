...
/**
 * Enum representing different Placeholder-compatible chains.
 */
declare enum PlaceholderChain {
 ...
 */
type Chain = EvmChain | AptosChain | SolanaChain | InitiaChain | TonChain | PlaceholderChain;
/**
 * Object containing all supported chains.
 */
declare const Chain: {
    PLACEHOLDER0: PlaceholderChain.PLACEHOLDER0;
    TON: TonChain.TON;
...
declare const EndpointId: {
    ...
    PLACEHOLDER0_V2_TESTNET: TestnetV2EndpointId.PLACEHOLDER0_V2_TESTNET;
    ...
    PLACEHOLDER0_V2_MAINNET: MainnetV2EndpointId.PLACEHOLDER0_V2_MAINNET;
...
declare enum ChainKey {
    ...
    KATANA = "katana",
    BOTANIX = "botanix",
    PLACEHOLDER0_TESTNET = "placeholder0-testnet",
    PLACEHOLDER0 = "placeholder0",
